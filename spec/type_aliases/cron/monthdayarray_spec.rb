...
describe 'Simplib::Cron::MonthDayArray' do
  ...
  context 'with invalid parameters' do
    it { is_expected.not_to allow_value( 22 ) }
    it { is_expected.not_to allow_value( '22' ) }
    it { is_expected.not_to allow_value( '20-23' ) }
    it { is_expected.not_to allow_value( '*' ) }
    it { is_expected.not_to allow_value( '*/5' ) }
    it { is_expected.not_to allow_value( '1-23/2' ) }
