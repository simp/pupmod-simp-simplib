...
describe 'Simplib::Cron::MonthDay' do
  context 'with valid parameters' do
    ...
    it { is_expected.to allow_value('?')}
    it { is_expected.to allow_value('W')}
    it { is_expected.to allow_value('13W')}
    it { is_expected.to allow_value('LW')}
    it { is_expected.to allow_value('WL')}
    it { is_expected.to allow_value('/3')}
    it { is_expected.to allow_value('2/10')}
    it { is_expected.to allow_value('1,3-5,2/7')}
  end
  context 'with invalid parameters' do
    it { is_expected.not_to allow_value('W12')}
    ...
    it { is_expected.not_to allow_value('24,12,13W')}
    it { is_expected.not_to allow_value('24,12-15,13W')}
    it { is_expected.not_to allow_value('24L')}
