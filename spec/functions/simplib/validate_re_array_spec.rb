  ...
  context 'with invalid inputs' do
    ...
    it 'rejects an array against an array' do
      is_expected.to run.with_params(['none', 'no one'], ['all', 'every']).and_raise_error(
        %r{"none" does not match \["all", "every"\]},
      )
    end
