...
<!-- Using 'strings' fork from `gem 'puppet-strings', :git => 'https://github.com/glennsarti/puppet-strings', :branch => 'add-datatype-support'` until it is pulled into the mainline. -->
